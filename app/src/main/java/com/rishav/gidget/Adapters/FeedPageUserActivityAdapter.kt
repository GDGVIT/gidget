...
class FeedPageUserActivityAdapter(
    private val context: Context,
    private val feedPageDataList: MutableList<FeedPageModel>
) :
    RecyclerView.Adapter<FeedPageUserActivityAdapter.FeedPageUserActivityViewHolder>() {
    ...
    override fun onBindViewHolder(holder: FeedPageUserActivityViewHolder, position: Int) {
        ...
        when (currentItem.type) {
            ...
            "PullRequestEvent" -> holder.eventPhoto.setImageResource(R.drawable.github_pull_request)
